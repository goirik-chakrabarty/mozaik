...
class RandomSingleNeuronStepCurrentInjectionDuringDriftingSinusoidalGratingStimulation(VisualExperiment):
    """
    This experiment schedules many single neuron injections, whereby neurons are randomly picked from the set defined by 
    population selector provided in stimulation_configuration.
    ...
    def generate_stimuli(self):
            ...
            population_selector = load_component(self.parameters.stimulation_configuration.component)
            ids = population_selector(self.model.sheets[self.parameters.sheet],self.parameters.stimulation_configuration.params).generate_idd_list_of_neurons()
                  ...
                  for i in range(0, self.parameters.grating_num_orientations):
                        for t in range(0,self.parameters.num_trials):
                              ...
                              for idd in ids:
                                    ...
                                    d[self.parameters.sheet] = [Depolarization(self.model.sheets[self.parameters.sheet],p)]
                                    ...
                                    self.stimuli.append(topo.FullfieldDriftingSinusoidalGrating(
                                                      ...
                                                      trial=t,
                                                      orientation=np.pi/self.parameters.grating_num_orientations*i,
